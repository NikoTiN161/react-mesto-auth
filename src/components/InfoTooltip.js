function InfoTooltip(props) {
    ...
    return (
        <div className={`overlay overlay_type_info-tooltip ${props.isOpen && 'overlay_opened'}`} onMouseDown={props.onClickOverlay}>
            <div className="overlay__container overlay__container_type_info-tooltip">
